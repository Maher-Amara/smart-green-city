...
<head>
    ...
    <title>Green Smart City - Home</title>
        <link rel="shortcut icon" href="<?= base_url('assets/favicon.ico') ?>">
        <link rel="apple-touch-icon" href="<?= base_url('assets/icon.png') ?>">

    <meta name="description" content="Green Smart City admin page">
    ...
    <aside id="left-panel" class="left-panel">
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand hidden" href="./"><img src="<?= base_url('assets/images/logo.png') ?>" alt="Logo"></a>
            </div>
